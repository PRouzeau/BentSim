...
merged_idler = true;
//Le brin mou de la chaîne est au-dessus de la poulie
drv_chain_bot = true;
//Angle de la chaine supérieure depuis le plateau (/ horizontale)
chain_angle = 30.1;
//Longueur de la chaine supérieure depuis le plateau
chain_length = 550;
//Le brin mou de la chaîne est au-dessus de la poulie
rt_chain_top = false;
//Angle chaîne sous le plateau - utilisé si poulies disjointes
chain_ang_bot = 16.2;
//Longueur chaine en dessous du plateau - utilisé si poulies disjointes
chain_length_bot = 540;
//Angle de la chaîne arrière supérieure
chain_rear_top_angle = -11.9;
//Angle de la chaîne arrière inférieure
chain_rear_bot_angle = -9.3;
//Longueur du brin tendu de la chaîne arrière
chain_rear_length = 925;
//Longueur du brin mou de la chaîne arrière
